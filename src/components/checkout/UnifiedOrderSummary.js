// components/checkout/UnifiedOrderSummary.jsx - Works with both cart and buy now
"use client";
...
function MobileContent({
  ...
  return (
    <>
      {/* Items List */}
      <div className="space-y-3 max-h-[25vh] overflow-y-auto scrollbar-hide">
        {/* Coupon Section */}
...
function PriceBreakdown({
  ...
  return (
    <div className="">
        ...
        <div className="flex flex-col items-center justify-center mt-0 text-gray-500">
          ...
          >
            ...
            <path
              ...
              d="M7 8l5-5 5 5"
            />
            {/* Bottom arrow - positioned directly below with minimal gap */}
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth={2}
      ...
      {!isMobile && (
        <div className="flex items-center justify-center text-xs text-gray-500 p-4">
          <svg
