...
export default function Navbar() {
  ...
  return (
    <>
      {/* Fixed Navbar */}
      <nav className="fixed h-[9vh] top-0 left-0 right-0 flex items-center justify-between px-4 py-3 z-50 border-b-2 border-black bg-black/20 " style={{backdropFilter:"blur(5px)"}}>
